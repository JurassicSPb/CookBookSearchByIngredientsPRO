...
import com.ggl.jr.cookbooksearchbyingredientsPRO.nav_drawer_extras.WeightsAndMeasures;
...
import com.ggl.jr.cookbooksearchbyingredientsPRO.timer.TimerActivity;
import com.ggl.jr.cookbooksearchbyingredientsPRO.user_recipes.UserRecipeListActivity;
...
//            toolbarTextView.setMarqueeRepeatLimit(2);
    ...
    private void initData() {
        if (preferences.getFlagIngrCatV2_9()) {
            createIngredientsRU();
            createCategoryTablesRU();
            createCategoriesRU();
            preferences.setFlagIngrCatV2_9(false);
        }
        ...
        if (preferences.getFlagRecipesV2_4()) {
            createRecipes("ver2_4");
            preferences.setFlagRecipesV2_4(false);
        }

        if (preferences.getFlagRecipesV2_5()) {
            createRecipes("ver2_5");
            preferences.setFlagRecipesV2_5(false);
        }
    ...
    private void createIngredientsRU() {
        ...
        bufferIngredient.add(new Ingredient(1, "грузди", R.drawable.gruzd, 0, 0));
        bufferIngredient.add(new Ingredient(1, "лисички", R.drawable.lisichki, 0, 0));
        bufferIngredient.add(new Ingredient(1, "маслята", R.drawable.maslata, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(2, "кус-кус", R.drawable.kus_kus, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(3, "листы для лазаньи", R.drawable.lasanja, 0, 0));
        bufferIngredient.add(new Ingredient(3, "макароны", R.drawable.makaroni, 0, 0));
        bufferIngredient.add(new Ingredient(3, "рисовая лапша", R.drawable.ris_lapsha, 0, 0));
        bufferIngredient.add(new Ingredient(3, "спагетти", R.drawable.spagetti, 0, 0));
        bufferIngredient.add(new Ingredient(3, "тальятелле", R.drawable.tagliatelle, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(5, "кокосовое молоко", R.drawable.coc_milk, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(5, "масло топленое", R.drawable.maslo_topl, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(6, "осьминог", R.drawable.octopus, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(8, "кролик", R.drawable.rabbit, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(8, "пепперони", R.drawable.pepperoni, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(9, "херес", R.drawable.heres, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(10, "батат", R.drawable.batat, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(10, "кольраби", R.drawable.kolrabi, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(10, "овощи", R.drawable.veg, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(10, "шнитт-лук", R.drawable.shnitt, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(11, "кешью", R.drawable.keshyu, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(11, "семена чиа", R.drawable.chia, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(12, "анис", R.drawable.anis, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(12, "шалфей", R.drawable.shalfey, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(13, "гусь", R.drawable.goose, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(13, "утка", R.drawable.duck, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(14, "анчоус", R.drawable.anchous, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(14, "кета", R.drawable.keta, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(14, "нерка", R.drawable.nerka, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(15, "мюсли", R.drawable.musli, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(15, "попкорн", R.drawable.popkorn, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(15, "яблочное пюре", R.drawable.yabl_pure, 0, 0));

        bufferIngredient.add(new Ingredient(16, "аджика", R.drawable.adzhika, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(16, "рыбный соус", R.drawable.rib_sous, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(19, "папайя", R.drawable.papaya, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(19, "хурма", R.drawable.hurma, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(20, "маца", R.drawable.matza, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(20, "тортилья", R.drawable.tortillas, 0, 0));
        ...
        bufferIngredient.add(new Ingredient(22, "меланж", R.drawable.melanzh, 0, 0));
