...
public class MyPreferences {
    ...
    private static final String KEY_STOP_LIST_V_1_8 = "key_recipes_fav_v_1_8";
    private static final String KEY_INGR_AND_CAT_V_1_8 = "key_ingr_and_cat_v_1_8";
    private static final String KEY_INGR_FAV_V_1_8 = "key_ingr_fav_v_1_8";
    ...
    public boolean getFlagStopListV1_8() {
        return preferences.getBoolean(KEY_STOP_LIST_V_1_8, true);
    }

    public void setFlagStopListV1_8(boolean flag) {
        preferences.edit()
                .putBoolean(KEY_STOP_LIST_V_1_8, flag)
                .apply();
    }

    public boolean getFlagIngrFavV1_8() {
        return preferences.getBoolean(KEY_INGR_FAV_V_1_8, true);
    }

    public void setFlagIngrFavV1_8(boolean flag) {
        preferences.edit()
                .putBoolean(KEY_INGR_FAV_V_1_8, flag)
                .apply();
    }

    public boolean getFlagIngrCatV1_8() {
        return preferences.getBoolean(KEY_INGR_AND_CAT_V_1_8, true);
    }

    public void setFlagIngrCatV1_8(boolean flag) {
        preferences.edit()
                .putBoolean(KEY_INGR_AND_CAT_V_1_8, flag)
                .apply();
    }
